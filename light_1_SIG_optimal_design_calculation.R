...
saveRDS(lightResc5,"light_SIG_optimal_design_5_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(lightResc7,"light_SIG_optimal_design_7_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(lightResc10,"light_SIG_optimal_design_10_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(lightResc15,"light_SIG_optimal_design_15_points.rds")
