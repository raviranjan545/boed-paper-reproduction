...
#Source the new stable C++ SIG calculation function - UPDATE FILE PATH
source("/home/ranjan/bayesianDesigns/stable_SIG_CPP_function.R")

#Call the amended utility function - UPDATE FILE PATH
...
saveRDS(nutResc5,"nutrients_SIG_optimal_design_5_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(nutResc7,"nutrients_SIG_optimal_design_7_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(nutResc10,"nutrients_SIG_optimal_design_10_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(nutResc15,"nutrients_SIG_optimal_design_15_points.rds")
