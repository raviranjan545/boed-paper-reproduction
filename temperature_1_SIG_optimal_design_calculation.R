...
# Load the stable functions that can deal with the censoring - PATH NEEDS UPDATING
source("/home/ranjan/bayesianDesigns/stable_SIG_CPP_function.R")

# Load the prior function - PATH NEEDS UPDATING
source("/home/ranjan/bayesianDesigns/temperature_prior.R")

# Call the amended utility function - PATH NEEDS UPDATING
source("/home/ranjan/bayesianDesigns/new_utility_function.R")
...
# With lesser cores, it might take more than a week to finish with current settings.
...
# Save design - PATH NEEDS UPDATING
saveRDS(tempResc5,"temperature_SIG_optimal_design_5_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(tempResc7,"temperature_SIG_optimal_design_7_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(tempResc10,"temperature_SIG_optimal_design_10_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(tempResc15,"temperature_SIG_optimal_design_15_points.rds")
