...
#Source the new stable C++ SIG calculation function - PATH NEEDS UPDATING
...
saveRDS(doseResponse5,"toxin_SIG_optimal_design_5_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(doseResponse7,"toxin_SIG_optimal_design_7_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(doseResponse10,"toxin_SIG_optimal_design_10_points.rds")
...
# Save design - PATH NEEDS UPDATING
saveRDS(doseResponse15,"toxin_SIG_optimal_design_15_points.rds")
